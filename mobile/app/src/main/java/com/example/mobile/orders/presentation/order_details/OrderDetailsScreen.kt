...
//                date = uiState.selectedItem!!.createdAt,
//                code = uiState.selectedItem!!.code
//            )
...
//            }
//            TotalPrice(
//                price = formattedPrice(uiState.selectedItem!!.price)
//            )
//            HorizontalDivider()
//            DeliveryDetails(
//                address = uiState.selectedItem!!.address.toString(),
//                instructions = uiState.selectedItem!!.instructions.toString()
//            )
        }
    }
