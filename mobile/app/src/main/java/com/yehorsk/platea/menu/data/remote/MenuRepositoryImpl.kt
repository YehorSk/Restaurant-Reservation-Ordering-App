...
class MenuRepositoryImpl @Inject constructor(
    ...
    override suspend fun updateMenuItemPrice(id: String, price: String) {
        menuDao.updateMenuItemPrice(id, price)
    }

    override suspend fun changeMenuItemAvailability(id: String, available: Int) {
        menuDao.changeMenuItemAvailability(id, available)
    }
