  ...
  <v-dialog v-model="dialog" max-width="900" persistent>
    ...
    >
      ...
      <template v-slot:actions>
        ...
        <v-btn class="font-medium text-green-600 dark:text-green-500 hover:underline" :text="$t('default.Update')" @click="dialog = false, reservationStore.updateReservation(edit_reservation)"></v-btn>
      </template>
    </v-card>
  </v-dialog>
</template>
